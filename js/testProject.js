(function(){
	...
	TestPoject.prototype.load = function(){
		this.charResource = this.resourceManager.add("images/orcbase.png?" + new Date().getTime(),1,'orc');
	...
	TestPoject.prototype.init = function(){
		...
		for(var i = 0; i < 500; i++){
			var y = this.utilities.getRandomRange(0,Game.bounds.height),
			    x = this.utilities.getRandomRange(0,Game.bounds.width),
